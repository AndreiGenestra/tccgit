...
<head>
    ...
    <link href="./csspaginas/comunidadejogos.css" rel="stylesheet">
    <title>Comunidade de Jogos</title>
</head>
...
<body>
  ...
  <!--  fim da Navbar --> 
        ...
        <img src="./src/img/jogos.jpg"class="background-comunidade-perfil">  
        <div class="content-above">
            <h1 class="titulo1"><img class="perfil-foto-comunidade" src="">Comunidade de Jogos</h1>
